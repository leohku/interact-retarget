...
# filenames = [f[:-4] for f in os.listdir('C:/Dev/interact-retarget/fbx_single') if f.endswith('.fbx')]
filenames = [f[:-4] for f in os.listdir('C:/Dev/interact-retarget/fbx_multi') if f.endswith('.fbx') and '_' in f]

for file in filenames:
    
    # input_file = 'C:/Dev/interact-retarget/fbx_single/'+file+'.fbx'
    # output_file = 'C:/Dev/interact-retarget/bvh_single/'+file+'.bvh'
    input_file = 'C:/Dev/interact-retarget/fbx_multi/'+file+'.fbx'
    output_file = 'C:/Dev/interact-retarget/bvh_multi/'+file+'.bvh'
